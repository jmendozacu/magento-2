<?php
/**
 * Tab for substituted products grid
 *
 * @category  Orcab
...
class Substituted extends Extended
{
    /**
     * Core registry.
     *
    ...
    {
        parent::_construct();
        $this->setId('substituted_product_grid');
    ...
    {
        return $this->getProduct() && $this->getProduct()->getSubstitutedReadonly();
    }
    ...
    {
        return $this->_getData('grid_url') ?: $this->getUrl('orcab_catalog/*/substitutedGrid', ['_current' => true]);
    }

    /**
     * Retrieve selected substituted products.
     *
     * @return array
     */
    protected function getSelectedProducts()
    {
        $products = $this->getSubstitutedProducts();
        if (!is_array($products)) {
            $products = array_keys($this->getSelectedSubstitutedProducts());
        }
    ...
    /**
     * Retrieve substituted products.
     *
     * @return array
     */
    public function getSelectedSubstitutedProducts()
    {
        $products = [];

        foreach ($this->coreRegistry->registry('current_product')->getSubstitutedProducts() as $product) {
