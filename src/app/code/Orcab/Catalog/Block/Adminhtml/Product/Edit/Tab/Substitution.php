<?php
/**
 * Tab for substitution products grid
 *
 * @category  Orcab
...
class Substitution extends Extended
{
    /**
     * Core registry.
     *
    ...
    {
        parent::_construct();
        $this->setId('substitution_product_grid');
    ...
    {
        return $this->getProduct() && $this->getProduct()->getSubstitutionReadonly();
    }
    ...
    {
        return $this->_getData('grid_url') ?: $this->getUrl('orcab_catalog/*/substitutionGrid', ['_current' => true]);
    }

    /**
     * Retrieve selected substitution products.
     *
     * @return array
     */
    protected function getSelectedProducts()
    {
        $products = $this->getSubstitutionProducts();
    ...
    /**
     * Retrieve substitution products.
     *
     * @return array
     */
    public function getSelectedSubstitutionProducts()
    {
        ...
        foreach ($this->coreRegistry->registry('current_product')->getSubstitutionProducts() as $product) {
