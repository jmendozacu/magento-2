<?php
/**
 * Tab for substitute products grid
 *
 * @category  Orcab
...
class Substitute extends Extended
{
    /**
     * Core registry.
     *
    ...
    {
        parent::_construct();
        $this->setId('substitute_product_grid');
    ...
    {
        return $this->getProduct() && $this->getProduct()->getSubstituteReadonly();
    }
    ...
    {
        return $this->_getData('grid_url') ?: $this->getUrl('orcab_catalog/*/substituteGrid', ['_current' => true]);
    }

    /**
     * Retrieve selected substitute products.
     *
     * @return array
     */
    protected function getSelectedProducts()
    {
        $products = $this->getSubstituteProducts();
        if (!is_array($products)) {
            $products = array_keys($this->getSelectedSubstituteProducts());
        }
    ...
    /**
     * Retrieve substitute products.
     *
     * @return array
     */
    public function getSelectedSubstituteProducts()
    {
        $products = [];

        foreach ($this->coreRegistry->registry('current_product')->getSubstituteProducts() as $product) {
