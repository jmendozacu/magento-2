...
class Substituted extends Upsell
{
    ...
    protected function _prepareData()
    {
        ...
        $this->_itemCollection = $product->getSubstitutedProductCollection()->setPositionOrder()->addStoreFilter();
